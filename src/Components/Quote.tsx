...
const Quote = ({id, gallonsreq, address1, deliveryDate, suggestedPrice, totalDue}:QuoteProps) => {
  return (
    <li className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Past Quote</h5>
        <div className='mb-3'>
            <div>ID:{id}</div>
